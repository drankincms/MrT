...
if __name__ == "__main__":
    ...
    #convert_lhe("../PROC_sm_2/Events/run_02/unweighted_events.lhe",fname_out='./events_SM_qqvv_550gev.root')
    #convert_lhe("../PROC_sm_2/Events/run_03/unweighted_events.lhe",fname_out='./events_SM_qqvv_250gev.root')
    #convert_lhe("../PROC_LO_LQ_S1_2/Events/run_02/unweighted_events.lhe",fname_out='./events_LQ_S1_M650_qq_550gev.root')
    #convert_lhe("../PROC_LO_LQ_S1_2/Events/run_03/unweighted_events.lhe",fname_out='./events_LQ_S1_M650_qq_250gev.root')
    #convert_lhe("../PROC_LO_LQ_S1_2/Events/run_04/unweighted_events.lhe",fname_out='./events_LQ_S1_M2000_qq_550gev.root')
    #convert_lhe("../PROC_LO_LQ_S1_2/Events/run_05/unweighted_events.lhe",fname_out='./events_LQ_S1_M2000_qq_250gev.root')
    convert_lhe("../PROC_sm_3/Events/run_01/unweighted_events.lhe",fname_out='./events_SM_qqmv_550gev.root')
    convert_lhe("../PROC_sm_4/Events/run_01/unweighted_events.lhe",fname_out='./events_SM_qqmv_250gev.root')
